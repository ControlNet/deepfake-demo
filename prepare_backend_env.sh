...
pip install fastapi==0.78.0 starlette==0.19.1 scipy==1.8.1 uvicorn==0.18.2 librosa==0.9.2 numpy~=1.22.0 opencv-python~=4.6.0.66 tqdm~=4.64.0 numba~=0.55.2 umap-learn visdom~=0.1.8.9 librosa>=0.8.0 sounddevice~=0.4.3 SoundFile~=0.10.3.post1 Unidecode~=1.3.2 inflect~=5.3.0 PyQt5~=5.15.6 numba webrtcvad scikit-learn~=1.0.1 audioread~=2.1.9 pydantic~=1.9.1 matplotlib>=3.3.0 albumentations==0.5.2 progress==1.5 pandas==1.2.4 pyyaml==5.4.1 einops==0.3.0 efficientnet_pytorch==0.7.1
...
unzip services/rtvc/pretrained_models.zip
